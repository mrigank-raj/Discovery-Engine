...
# ---------------------------------------------------------
# Cross-Reference with Primary Research
# NOTE: This section is manually written by the research team based on
# interview and survey findings. It is NOT generated by the AI pipeline —
# unlike the AI Executive Synthesis above, nothing here was produced by
# Groq/Gemini classification or synthesis calls.
# ---------------------------------------------------------
st.header("Cross-Reference with Primary Research")
st.caption("Manually authored by the project team — not AI-generated. Included to show where public-signal discovery and primary research (interviews + survey) do and don't independently agree.")

st.markdown("""
**Where the two methods independently agree:** The discovery engine's *Fit/Size Signal* category
(2 mentions, real Play Store quotes about fit and fabric quality) lines up with a pattern found
separately in our own survey (fit/size doubt is one of the most-cited reasons for not buying a
wishlisted item) and in interview data (one respondent described checking whether a liked item
exists in a different size or color on other apps before deciding). Three independent sources
converging on the same pattern is a genuine, if modest, form of corroboration.

**Where the label overlaps but the finding doesn't:** The discovery engine also surfaced a
*Price Signal* category, but its underlying quotes are general satisfaction/value reviews
("worth the price," "quality is fantastic") — not users describing hesitation over wishlist
price-timing. This is *not* independent confirmation of our Price-Confidence segment, and we're
naming that explicitly rather than letting a matching label imply agreement that isn't actually there.

**Why the Discover and Wishlist stages show no detected signal:** This is a meaningful finding on
its own, not a gap to explain away. Public app reviews and YouTube comments are written after a
purchase decision or a complaint — they don't capture the quiet, pre-purchase hesitation that
happens while an item sits in someone's wishlist. That's precisely why primary research (interviews
and survey), not public-signal mining, had to carry the core segmentation and problem-definition
